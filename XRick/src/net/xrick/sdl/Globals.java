...
class Globals
{
	...
	public static String ApplicationName = "XRick";
	public static String AppLibraries[] = { "sdl_native_helpers", "sdl-1.2" };
	public static String AppMainLibraries[] = {  "application", "sdl_main" };
	public static final boolean Using_SDL_1_3 = false;
	public static final boolean Using_SDL_2_0 = false;
	public static String[] DataDownloadUrl = { "!Data size is 1 Mb|:data.zip:data.zip",  };
	...
	public static String CommandLine = "xrick";
	...
	public static String[] AppTouchscreenKeyboardKeysNames = "Jump Crawl Fire Dynamite Stick".split(" ");
	public static int StartupMenuButtonTimeout = 3000;
	public static int AppMinimumRAM = 0;
	public static SettingsMenu.Menu HiddenMenuOptions [] = {  new SettingsMenuMisc.OptionalDownloadConfig(), }; // If you see error here - update HiddenMenuOptions in your AndroidAppSettings.cfg: change OptionalDownloadConfig to SettingsMenuMisc.OptionalDownloadConfig etc.
